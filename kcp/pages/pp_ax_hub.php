		...
		if( $res_cd == "0000" )
        {
			...
			//-------------------- extra info table handling--------------------------//
				...
				if(!$result3){
					$bSucc = false;
					echo "<script>
							alert('신용카드결제의 별도의정보를 저장하지 못했습니다.');
						  </script>";
				}				
			...
			//------------------------------ extra info table handling--------------------------//
				...
				if(!$result3){
					$bSucc = false;
					echo "<script>
							alert('가상계좌결제 별도의정보를 저장하지 못했습니다.');
						  </script>";
				}				
