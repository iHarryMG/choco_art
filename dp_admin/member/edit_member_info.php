...
<HEAD>
 ...
 <?
		...
		mysql_close($connect);
 ?>
 <form name="admin_form" action="save_member_list.php?num=<?echo $num?>" method="POST">
  	<div id="header">
		전체 회원 관리
	</div> 
	<div id="content">
...
?>
	...
	<div id="btns">
		...
		<input type="button" onclick="javascript:window.location.href='member_list.php'" value="목록" style="cursor:hand">
	</div>
</form>
 </BODY>
</HTML>
