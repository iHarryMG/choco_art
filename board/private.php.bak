...
<HEAD>
  ...
  <LINK href="design/private_design.css" type=text/css rel=stylesheet>
...
?>
				<ul>
					<li><a href="../membership/logout.php?win=board/private">로그아웃</a></li>
					<li>|</li>
...
?>					
			<ul>
				<li><a href="javascript:login('board/private')">로그인</a></li>
				<li>|</li>
...
?>
	...
	<div class="content">
		<img id="title_background" src="../images/title_background/chocos7.jpg">
		<img id="title" src="../images/title_background/private.png">
		<h5>HOME > BOARD > Private Question</h5>

		<iframe src="private_list.php" name="private_content" width='710px' height='550px' frameborder='0'></iframe>
	</div>
	<div id="sidemenu">
		...
		<div class="submenu">
			<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="160" height="170" id="chocoart_sidemenu_board_private" align="middle">
			<param name="allowScriptAccess" value="sameDomain" />
			<param name="movie" value="design/chocoart_sidemenu_board_private.swf" />
			<param name="quality" value="high" />
			<param name="wmode" value="transparent" />
			<param name="bgcolor" value="#000000" />
			<embed src="design/chocoart_sidemenu_board_private.swf" quality="high" wmode="transparent" bgcolor="#000000" width="160" height="170" name="chocoart_sidemenu_board_private" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
			</object>
		</div><!--.submenu end-->
