...
<HEAD>
  ...
  <LINK href="design/freeboard_design.css" type=text/css rel=stylesheet>
...
?>
	...
	<div class="content">
		<img src="../images/title_background/chocos11.jpg">
		<img id="title" src="../images/title_background/freeboard.png">
		<h5>HOME > BOARD > Free Board</h5>

		<iframe src="freeboard_list.php" name="freeboard_content" width='710px' height='550px' frameborder='0'></iframe>
	</div>
	<div id="sidemenu">
		...
		<div class="submenu">
			<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="160" height="170" id="chocoart_sidemenu_board_freeboard" align="middle">
			<param name="allowScriptAccess" value="sameDomain" />
			<param name="movie" value="design/chocoart_sidemenu_board_freeboard.swf" />
			<param name="quality" value="high" />
			<param name="wmode" value="transparent" />
			<param name="bgcolor" value="#000000" />
			<embed src="design/chocoart_sidemenu_board_freeboard.swf" quality="high" wmode="transparent" bgcolor="#000000" width="160" height="170" name="chocoart_sidemenu_board_freeboard" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
			</object>
		</div><!--.submenu end-->
