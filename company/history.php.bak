...
?>
				<ul>
					<li><a href="../membership/logout.php?win=company/history">로그아웃</a></li>
					<li>|</li>
...
?>					
			<ul>
				<li><a href="javascript:login('company/history')">로그인</a></li>
				<li>|</li>
...
?>
	...
	<div class="content">
		<img id="title_background" src="../images/title_background/chocos6.jpg">
		<img id="title" src="../images/title_background/history.png">
		<h5>HOME > ABOUT US > History</h5>
		...
		<tr valign=top>
			<td>
				<table id="smalltable">
					<?
						...
						$sql="select date, content from companyhistory order by num desc";
						$result=mysql_query($sql,$connect);
						$records=mysql_num_rows($result);
						$fields=mysql_num_fields($result);

						$firstHalfEnd=ceil(($records/2));
						$secondHalfStart=$firstHalfEnd;

						for($i=0; $i < $firstHalfEnd; $i++){
							echo("<tr >");
								$data1=mysql_result($result, $i, 0);
								echo("<td id='left'>● $data1</td>");
							echo("</tr>");
							echo("<tr >");
								$data2=mysql_result($result, $i, 1);
								echo("<td id='content'>$data2</td>");
							echo("</tr>");
						}
					?>
				</table>
			...
			<td>
				<table id="smalltable">
					<?
						for($i=$secondHalfStart; $i < $records; $i++){
							echo("<tr >");
							$data1=mysql_result($result, $i, 0);
							echo("<td id='left'>● $data1</td>");
							echo("</tr>");
	...
	<div id="sidemenu">
		...
		<div class="submenu">
			<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="160" height="200" id="chocoart_sidemenu_aboutus_history" align="middle">
			<param name="allowScriptAccess" value="sameDomain" />
			<param name="movie" value="design/chocoart_sidemenu_aboutus_history.swf" />
			<param name="quality" value="high" />
			<param name="wmode" value="transparent" />
			<param name="bgcolor" value="#663300" />
			<embed src="design/chocoart_sidemenu_aboutus_history.swf" quality="high" wmode="transparent" bgcolor="#663300" width="160" height="200" name="chocoart_sidemenu_aboutus_history" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
			</object>
		</div><!--.submenu end-->
