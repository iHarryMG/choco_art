...
<HEAD>
  ...
  <LINK href="design/exhibition_design.css" type=text/css rel=stylesheet>
...
?>
				<ul>
					<li><a href="../membership/logout.php?win=company/exhibition">로그아웃</a></li>
					<li>|</li>
...
?>					
			<ul>
				<li><a href="javascript:login('company/exhibition')">로그인</a></li>
				<li>|</li>
...
?>
	...
	<div class="content">
		<img src="../images/title_background/chocos3.jpg">
		<img id="title" src="../images/title_background/exhibition.png">
		<h5>HOME > ABOUT US > Exhibition</h5>

		<iframe src="exhibition_list.php" name="exhibition_content" width='710px' height='550px' frameborder='0'></iframe>
	</div>
	...
	<div id="sidemenu">
		...
		<div class="submenu">
			<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="160" height="200" id="chocoart_sidemenu_aboutus_exhibition" align="middle">
			<param name="allowScriptAccess" value="sameDomain" />
			<param name="movie" value="design/chocoart_sidemenu_aboutus_exhibition.swf" />
			<param name="quality" value="high" />
			<param name="wmode" value="transparent" />
			<param name="bgcolor" value="#663300" />
			<embed src="design/chocoart_sidemenu_aboutus_exhibition.swf" quality="high" wmode="transparent" bgcolor="#663300" width="160" height="200" name="chocoart_sidemenu_aboutus_exhibition" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
			</object>
		</div><!--.submenu end-->
