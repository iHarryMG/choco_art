...
?>
	...
	<div class="content">
		<img id="title_background" src="../images/title_background/chocos9.jpg">
		<img id="title" src="../images/title_background/brandstory.png">
		<h5>HOME > ABOUT US > Brand Story</h5>
		<img id="brantstory_content" src="../images/menu_images/brandstory.gif">
	</div>
	...
	<div id="sidemenu">
		...
		<div class="submenu">
			<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="160" height="200" id="chocoart_sidemenu_aboutus_brandstory" align="middle">
			<param name="allowScriptAccess" value="sameDomain" />
			<param name="movie" value="design/chocoart_sidemenu_aboutus_brandstory.swf" />
			<param name="quality" value="high" />
			<param name="wmode" value="transparent" />
			<param name="bgcolor" value="#663300" />
			<embed src="design/chocoart_sidemenu_aboutus_brandstory.swf" quality="high" wmode="transparent" bgcolor="#663300" width="160" height="200" name="chocoart_sidemenu_aboutus_brandstory" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
			</object>
		</div><!--.submenu end-->
