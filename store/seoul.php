<?
	...
	$sql = "select num from store_image where region='seoul' order by num asc";
...
<HEAD>
  ...
  <LINK href="design/seoul_design.css" type=text/css rel=stylesheet>
  <script type="text/javascript" src="http://apis.daum.net/maps/maps3.js?apikey=08e5853ae044a61f44d0d9cde3d3702066674c9b" charset="utf-8"></script> 
	...
	function viewstore(num){
		window.open("view_seoulstore.php?num="+num,"search_win", " scrollbars=auto, resizable=no, width=450, height=450 ");
	}

	window.onload = function() {
	  var position = new daum.maps.LatLng(37.491900169421875, 127.03099679922528);
	  ...
	  var infowindow = new daum.maps.InfoWindow({
		content: '<table id="mapcontent" align=center cellpadding=0>'+
					...
					'<tr><td align=center id="addr">서울시 강남구 역삼동 황화빌딩 1115호</td></tr>'+
				 '</table>',
...
?>
				<ul>
					<li><a href="../membership/logout.php?win=store/seoul">로그아웃</a></li>
					<li>|</li>
...
?>					
			<ul>
				<li><a href="javascript:login('store/seoul')">로그인</a></li>
				<li>|</li>
...
?>
	...
	<div class="content">
		...
		<img id="title" src="../images/title_background/seoulchocoart.png">
		<h5>HOME > STORE > Seoul Chocoart</h5>
	...
	<div id="sidemenu">
		...
		<div class="submenu">
			<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="160" height="170" id="chocoart_sidemenu_store_seoul" align="middle">
			<param name="allowScriptAccess" value="sameDomain" />
			<param name="movie" value="design/chocoart_sidemenu_store_seoul.swf" />
			<param name="quality" value="high" />
			<param name="wmode" value="transparent" />
			<param name="bgcolor" value="#000000" />
			<embed src="design/chocoart_sidemenu_store_seoul.swf" quality="high" wmode="transparent" bgcolor="#000000" width="160" height="170" name="chocoart_sidemenu_store_seoul" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
			</object>
		</div><!--.submenu end-->
